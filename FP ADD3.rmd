...
k3 <- kmeans(data, centers = 10, nstart = 25)
fviz_cluster(k3, data = pca_data[, c("PC1", "PC2")], geom = "point")
fviz_cluster(k3, data = pca_data[, c("PC1", "PC3")], geom = "point")
fviz_cluster(k3, data = pca_data[, c("PC1", "PC4")], geom = "point")
fviz_cluster(k3, data = pca_data[, c("PC2", "PC3")], geom = "point")
fviz_cluster(k3, data = pca_data[, c("PC2", "PC3")], geom = "point")
fviz_cluster(k3, data = pca_data[, c("PC3", "PC4")], geom = "point")
fviz_cluster(k3, data = data, geom = "point")
```
